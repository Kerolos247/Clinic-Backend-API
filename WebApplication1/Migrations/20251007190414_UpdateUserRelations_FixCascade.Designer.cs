...
namespace WebApplication1.Migrations
{
    ...
    [Migration("20251007190414_UpdateUserRelations_FixCascade")]
    partial class UpdateUserRelations_FixCascade
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WebApplication1.Models.Doctor", b =>
                {
                    ...
                    b.HasOne("WebApplication1.Models.ApplicationUser", "User")
                        .WithOne()
                        .HasForeignKey("WebApplication1.Models.Doctor", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("WebApplication1.Models.Patient", b =>
                {
                    b.HasOne("WebApplication1.Models.ApplicationUser", "User")
                        .WithOne()
                        .HasForeignKey("WebApplication1.Models.Patient", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
